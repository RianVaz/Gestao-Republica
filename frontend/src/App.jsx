...
export default function App() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'membros':
        return <div className="text-center mt-10">Módulo Moradores (Em breve)</div>;
      case 'tarefas':
        return <div className="text-center mt-10">Módulo Tarefas (Em breve)</div>;
      default:
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 flex font-sans">
      ...
      {/* Nosso componente importado e isolado */}
      <Sidebar 
        activeTab={activeTab} 
